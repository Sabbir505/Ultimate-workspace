...
async fn fetch_auto_models(cfg: &AutoProviderCfg) -> Result<Vec<AutoModelEntry>, String> {
    let base = cfg
        .base
        .clone()
...
fn scan_local_models_blocking(folder: Option<String>, db: &DbState) -> CmdResult<Vec<GgufModel>> {
