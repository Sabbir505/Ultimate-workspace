 ...
 *  provider icons when the install probe landed ~2s after first paint —
 *  read by users as "icons shrink after a load". One box, no surprises. */
