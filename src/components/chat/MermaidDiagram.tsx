  ...
  if (lastTheme !== theme) {
    mermaid.initialize({
      ...
      themeVariables:
        theme === "dark"
          ? {
              // Transparent canvas so the app's glass surface shows through.
              background: "transparent",
              mainBkg: "#1e2a3a",
              secondBkg: "#243346",
              tertiaryBkg: "#2c3e50",
              // Crisp, high-contrast edges and text on glass.
              lineColor: "#9fb4c8",
              textColor: "#e8eef5",
              edgeLabelBackground: "transparent",
              primaryColor: "#3a6ea5",
              primaryTextColor: "#e8eef5",
              primaryBorderColor: "#5b8ac4",
              secondaryColor: "#41536b",
              secondaryTextColor: "#e8eef5",
              secondaryBorderColor: "#5b7290",
              tertiaryColor: "#314155",
              tertiaryTextColor: "#e8eef5",
              tertiaryBorderColor: "#4a6178",
              fontSize: "14px",
            }
          : {
              background: "transparent",
              ...
              primaryBorderColor: "#7aa2cf",
              secondaryColor: "#e7eef5",
              secondaryTextColor: "#1c2530",
              secondaryBorderColor: "#9ab4cd",
              tertiaryColor: "#f1f5f9",
              tertiaryTextColor: "#1c2530",
              tertiaryBorderColor: "#aebcc8",
              fontSize: "14px",
            },
    });
    lastTheme = theme;
