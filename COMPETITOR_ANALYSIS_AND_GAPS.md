...
|---|---|---|---|
| P0 | **Worktree-per-session default** for new agent sessions (+ migration nudge) | §3.1.1 — the core orchestrator mechanic | M |
| P0 | **Per-turn checkpoints + one-click revert** (hidden git refs, à la T3 Code/Cline) | §3.1.2 — T3's signature safety feature | M |
